...
- [Prowlarr](https://github.com/prowlarr/prowlarr) **4,124** 💫 - Prowlarr is an indexer manager/proxy built on the popular arr .net/reactjs base stack to integrate with your various PVR apps. Prowlarr supports management of both Torrent Trackers and Usenet Indexers. It integrates seamlessly with Lidarr, Mylar3, Radarr, Readarr, and Sonarr offering complete management of your indexers with no per app Indexer setup required.
- [Jackett](https://github.com/Jackett/Jackett) **12,378** 💫 - API Support for your favorite torrent trackers. An alternative to Prowlarr.
...
- [Lidarr on Steroids](https://github.com/youegraillot/lidarr-on-steroids) **392** 🌟 - This repository bundles a modded version of Lidarr and Deemix into a docker image.
...
- [Mylar3](https://github.com/mylar3/mylar3) **1,085** 💫 - The python3 version of the automated Comic Book downloader (cbr/cbz) for use with various download clients.
...
- [Bazarr](https://github.com/morpheus65535/bazarr) **2,882** 💫 - Bazarr is a companion application to Sonarr and Radarr. It manages and downloads subtitles based on your requirements. You define your preferences by TV show or movie and Bazarr takes care of everything for you.
...
- [FlareSolverr](https://github.com/FlareSolverr/FlareSolverr) **7,864** 💫 - Proxy server to bypass Cloudflare protection.
...
- [Jellyseerr](https://github.com/Fallenbagel/jellyseerr) **3,889** 💫 - Fork of overseerr for jellyfin support.
...
- [Ombi](https://github.com/Ombi-app/Ombi) **3,744** 💫 - Ombi is a self-hosted web application that automatically gives your shared Plex or Emby users the ability to request content by themselves! Ombi can be linked to multiple TV Show and Movie DVR tools to create a seamless end-to-end experience for your users.
...
- [SuggestArr](https://github.com/giuseppe99barchetta/SuggestArr) **213** 🌟 - Automatic media content recommendations and download requests based on user activity on the media server.
- [Tdarr](https://github.com/HaveAGitGat/Tdarr) **3,050** 💫 - Tdarr - Distributed transcode automation using FFmpeg/HandBrake + Audio/Video library analytics + video health checking.
...
- [Dashy](https://github.com/Lissy93/dashy) **18,104** 💫 - A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more.
- [Flame](https://github.com/pawelmalak/flame) **5,320** 💫 - Flame is self-hosted startpage for your server. Easily manage your apps and bookmarks with built-in editors.
- [Heimdall](https://github.com/linuxserver/Heimdall) **7,891** 💫 - An Application dashboard and launcher.
- [Homarr](https://github.com/ajnart/homarr) **6,238** 💫 - Customizable browser's home page to interact with your homeserver's Docker containers.
- [Homepage](https://github.com/benphelps/homepage) **19,752** 💫 - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integration.
- [Homer](https://github.com/bastienwirtz/homer) **9,345** 💫 - A very simple static homepage for your server with offline health check.
